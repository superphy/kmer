...
for filename in os.listdir('../../Desktop/ecoli/biolog_csv'):
    path = os.path.abspath('../../Desktop/ecoli/biolog_csv/{0}'.format(filename))
    ...
    # set strain number
    df.at[6, 'Data File    '] = 'Strain Number'
    df.at[6, file_name] = number

    # set other
    df.at[7, 'Data File    '] = 'Other'
    df.at[7, file_name] = other
