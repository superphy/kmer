...
if __name__ == "__main__":
    ...
    # save everything
    np.save("annotation/15mer_data/Host_kmer_matrix.npy", kmer_matrix)
    np.save("annotation/15mer_data/Host_kmer_rows.npy", runs)
    np.save("annotation/15mer_data/Host_kmer_cols.npy", relevant_feats)
